...
describe('fs-crawler', () => {
  ...
  beforeEach(() => {
    ...
    crawler = new fsCrawler(defaultConfig);
  ...
  it('should reduce all files in root directory to a single object', done => {
    const config = { ...defaultConfig, match: ['**.txt'] };
    const obj = {
      [cwd]: {
        '/dir1': {
